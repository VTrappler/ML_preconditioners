...
from prec_data.data import GaussNewtonDataModule, TangentLinearDataModule
...
def main(config):
    ...
    datamodule = GaussNewtonDataModule(
        dim=state_dimension,
        path=data_path,
        ...
        shuffling=True,
        normalization=False,
        bck_error_covariance_matrix_path="/root/raw_data/background_error_lorenz_100.txt",
    )
